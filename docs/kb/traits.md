...
The TRAITS framework is a core innovation of the **Antigence™ Project (v0.2.0-alpha)**. It is documented in the preprint manuscript *[Antigence™ (powered by immunOS): SciFact Baseline and Negative-Selection AIS Framing](file:///Users/byron/projects/immunos-preprint/publication/manuscript/immunos-preprint-v1.md)* and is intended for attribution in Zenodo and bioRxiv releases.
