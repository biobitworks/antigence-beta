...
```
<workspace>/                         ← Working directory (all projects)
...
**Pros of hiding:**
1. Keeps your workspace directory clean for actual projects
...
**Working Directory**: `<workspace>/` (your local projects directory)
...
ln -s ~/.immunos/journal ~/projects/journals-immunos
```
